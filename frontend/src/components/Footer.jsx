      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-xs">
              Next-generation AI diagnostics. Empowering healthcare professionals with deep learning for Brain Tumor detection and automated Blood Report analysis.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="#brain-tumor" className="text-slate-400 hover:text-cyan-400 text-sm transition-colors">
                  Brain Tumor AI
                </Link>
              </li>
              <li>
                <Link href="#blood-report" className="text-slate-400 hover:text-cyan-400 text-sm transition-colors">
                  Blood Report Analysis
                </Link>
              </li>
              <li>
                <Link href="#project-report" className="text-slate-400 hover:text-cyan-400 text-sm transition-colors">
                  Documentation
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="mailto:support@neurox.ai" className="text-slate-400 hover:text-cyan-400 text-sm transition-colors">
                  Contact Us
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-slate-500 text-sm text-center md:text-left mb-4 md:mb-0">
            &copy; {currentYear} NeuroX AI Project. All rights reserved.
          </p>
